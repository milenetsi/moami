...
public class ChartOutput extends ApplicationFrame {
     ...
     */
    public ChartOutput(final String title, Settings s) {

        super(title);

        ModifierOutputImpl mOutput = new ModifierOutputImpl(new FiniteOutputValuesImpl(), 0, s.getA1Output(), s.getA2Output(), s.getuOutput(), s.getLowestOutputValue(), s.getHighestOutputValue());
