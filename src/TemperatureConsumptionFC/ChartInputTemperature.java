...
public class ChartInputTemperature extends ApplicationFrame {
     ...
     */
    public ChartInputTemperature(final String title, Settings s) {

        super(title);

        ModifierInputImplT mInput = new ModifierInputImplT(new FiniteInputValuesImplT(), s.getA1Input1(), s.getA2Input1(), s.getB1Input1(), s.getB2Input1(),
